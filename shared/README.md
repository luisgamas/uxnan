...
![Contracts](https://img.shields.io/badge/82_methods_%7C_22_notifications-blue?style=for-the-badge)
...
> **Status:** implemented and stable — **82 JSON-RPC methods** + **22 streaming
...
| Replica sync | `sync/changes` (`SyncChanges`: revisioned threads, projects, settings, deletions, presence), `BridgeSettings { home }`, `ClientPresence`, `Project` registry fields, `Turn.seq`, `Thread.origin` (`src/models/sync.ts`, architecture/02a §5.8.17) |
