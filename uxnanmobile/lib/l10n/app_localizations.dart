...
abstract class AppLocalizations {
  ...
  /// Connection status label when the secure channel is established.
  ///
  /// In en, this message translates to:
  /// **'Connected'**
  String get connectionConnected;

  /// Connection status label while establishing the connection.
  ///
  /// In en, this message translates to:
  /// **'Connecting…'**
  String get connectionConnecting;

  /// Connection status label when there is no active connection.
  ///
  /// In en, this message translates to:
  /// **'Disconnected'**
  String get connectionDisconnected;

  /// Connection status label while attempting to reconnect.
  ///
  /// In en, this message translates to:
  /// **'Reconnecting…'**
