...
- **Provider-agnostic, real multi-agent support.** It is not tied to a single
  vendor. Six real agents are wired today — OpenCode, Claude Code, Codex, pi,
  Gemini CLI and Zero — and you select the agent and model per conversation.
...
flowchart LR
  ...
  subgraph pc["💻 your PC"]
    ...
    a1["agents<br/>opencode · claude · codex · pi · gemini · zero"]
  end
