...
export function setTerminalLayout(layout: SavedTerminalLayout | null): Promise<void> {
...
export function setWorktreeOrder(repoId: string, paths: string[]): Promise<RepoData> {
...
export function githubRepoContext(worktreePath: string): Promise<RepoContext | null> {
...
export function githubPrTimeline(worktreePath: string, number: string): Promise<TimelineEvent[]> {
...
export function githubPrCreate(worktreePath: string, options: PrCreateOptions): Promise<string> {
...
export function githubPrComment(worktreePath: string, number: string, body: string): Promise<void> {
...
export function githubPrReady(worktreePath: string, number: string, undo = false): Promise<void> {
  return invoke('github_pr_ready', { worktreePath, number, undo });
}

/** Turn off a PR's armed auto-merge. */
export function githubPrDisableAutoMerge(worktreePath: string, number: string): Promise<void> {
...
export function githubAiDraftPr(worktreePath: string, base?: string | null): Promise<string> {
...
export function diagnosticsLog(level: string, source: string, message: string): Promise<void> {
