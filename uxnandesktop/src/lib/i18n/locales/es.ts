...
export const es: Record<MessageKey, string> = {
  ...
  "bridge.modeLabel.managed": "Iniciar el bridge cuando haga falta",
  ...
  "bridge.modeDesc.managed": "Conectarse a un bridge en marcha, o iniciar `uxnan-bridge` si no hay ninguno y detenerlo al cerrar Uxnan.",
  ...
  "bridge.statusConnectedManaged": "Conectado — bridge {version}, iniciado por Uxnan",
  ...
  "bridge.phonesDesc": "Teléfonos conectados a este bridge ahora mismo. Empareja uno nuevo con `uxnan-bridge qr` en una terminal.",
