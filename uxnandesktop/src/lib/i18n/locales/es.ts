...
export const es: Record<MessageKey, string> = {
  ...
  "toast.projectRemovedElsewhere": "Proyecto quitado desde otro dispositivo",
  ...
  "sidebar.connectPhone": "Conectar un teléfono",
  "sidebar.connectPhoneHint": "Empareja Uxnan Mobile con esta computadora: escanea un código QR y listo.",
  "sidebar.phoneAndOthers": "{name} +{n}",
  "sidebar.phoneOnline": "{name} está conectado",
  "sidebar.phoneOffline": "{name} no está conectado ahora",
  ...
  "welcome.eyebrow": "Bienvenido a Uxnan",
  "welcome.welcome.title": "Todos tus agentes de código, en un solo lugar.",
  "welcome.welcome.body": "Ejecuta Claude Code, Codex, OpenCode, pi y los demás lado a lado — cada uno en su propia terminal o chat, en su propio worktree — y ve de un vistazo qué está haciendo cada uno.",
  "welcome.modes.title": "Terminal o chat, tú decides.",
  "welcome.modes.body": "Abre un agente en una terminal para su interfaz completa, o en una pestaña de chat para una conversación tranquila: aprobaciones y preguntas encima del campo de texto, / para sus comandos y skills, @ para archivos, e imágenes.",
  "welcome.modes.terminal": "Terminal",
  "welcome.modes.chat": "Chat",
  "welcome.modes.approval": "Editar 2 archivos",
  "welcome.modes.approve": "Aprobar",
  "welcome.phone.title": "Tu teléfono, en la misma conversación.",
  "welcome.phone.body": "Empareja Uxnan Mobile una vez. Tus proyectos y chats son los mismos en ambos, el teléfono sigue funcionando con Uxnan cerrado, y lo que hagas en uno aparece en el otro — incluso lo que hiciste sin conexión.",
  "welcome.phone.connect": "Conectar un teléfono",
  "welcome.phone.linked": "Enlazado con Uxnan Desktop",
  "welcome.phone.message": "Escribe a Claude Code…",
  "welcome.team.title": "Agentes que trabajan juntos.",
  "welcome.team.body": "Dentro de Uxnan, los agentes tienen sus herramientas: crear un worktree, darle una tarea a otro agente, abrir el navegador, leer una terminal. Desde fuera, uxnan-cli y la API de control hacen lo mismo, y las automatizaciones los ejecutan con horario.",
  "welcome.agents.title": "Tus agentes.",
  "welcome.agents.body": "Estos son los agentes de código encontrados en esta computadora. Agrega otros cuando quieras en Ajustes → Agentes; Uxnan detecta solo uno recién instalado.",
  "welcome.ready.title": "Todo listo.",
  "welcome.ready.body": "Algunas teclas que conviene conocer; puedes cambiar cualquiera en Ajustes → Atajos.",
  "welcome.ready.search": "Buscar un proyecto o worktree",
  "welcome.ready.addProject": "Agregar un proyecto",
  "welcome.ready.newTerminal": "Nueva terminal",
  "welcome.ready.settings": "Ajustes",
  "welcome.ready.addFirstProject": "Agrega tu primer proyecto",
  "welcome.skip": "Omitir",
  "welcome.back": "Atrás",
  "welcome.next": "Siguiente",
  "welcome.done": "Empezar",
  "welcome.progress": "Pasos del recorrido",
  "sidebarProfile.welcome": "Recorrido de bienvenida",
  ...
  "ports.title": "Puertos",
  "ports.caption": "En las máquinas a las que estás conectado",
  "ports.refreshTooltip": "Preguntar a los hosts qué están escuchando",
  "ports.open": "Abrir",
  "ports.openTooltip": "Abrir la vista previa",
  "ports.forwardTooltip": "Traerlo aquí y abrir la vista previa",
  "ports.stop": "Dejar de reenviar",
  "ports.copy": "Copiar la dirección local",
  "ports.copied": "Copiado",
  "ports.announced": "anunciado",
  "ports.found": "escuchando",
  "ports.forwardingDisabled": "Ese host no permite reenvío de puertos (AllowTcpForwarding)",
  "ports.nothingListening": "Nada respondió en el 127.0.0.1 de ese host; puede que el servicio escuche en otra dirección de esa máquina",
  "ports.nothingListeningAt": "Nada respondió en {address} de ese host",
  "ports.reachableThere": "accesible en la red de esa máquina",
  "ports.empty": "Nada todavía. Un servidor de desarrollo en un host aparece aquí en cuanto imprime su dirección; o pulsa refrescar para preguntar.",
  ...
  "fileTree.deleteTitleHost": "¿Eliminar en {host}?",
  "fileTree.deleteFileDescHost": "«{name}» se eliminará en {host}. Esa máquina no tiene papelera, así que no se puede deshacer.",
  "fileTree.deleteFolderDescHost": "La carpeta «{name}» y todo su contenido se eliminarán en {host}. Esa máquina no tiene papelera, así que no se puede deshacer.",
  "fileTree.deleteConfirmHost": "Eliminar definitivamente",
  ...
  "editor.search.next": "Siguiente coincidencia (Enter)",
  "editor.search.previous": "Coincidencia anterior (Shift+Enter)",
  "editor.search.count": "{current} de {total}",
  "editor.search.noResults": "Sin resultados",
  "editor.search.options": "Opciones de búsqueda",
  "editor.search.showReplace": "Mostrar reemplazar",
  "editor.search.hideReplace": "Ocultar reemplazar",
  "editor.search.matchCase": "Mayúsculas",
  "editor.search.regexp": "Regex",
  "editor.search.byWord": "Palabra completa",
  "editor.search.replaceOne": "Reemplazar",
  "editor.search.replaceAll": "Reemplazar todo",
  ...
  "shortcuts.toggleRightSidebar": "Alternar dock derecho",
  "shortcuts.toggleRightSidebarDesc": "Muestra u oculta el dock derecho (Archivos · Git · GitHub · Navegador) de este workspace.",
  "shortcuts.dockFiles": "Archivos",
  "shortcuts.dockFilesDesc": "Muestra Archivos en el dock (abriéndolo si hace falta).",
  "shortcuts.dockGit": "Git",
  "shortcuts.dockGitDesc": "Muestra Git —cambios e historial— en el dock (abriéndolo si hace falta).",
  "shortcuts.dockGithub": "GitHub",
  "shortcuts.dockGithubDesc": "Muestra GitHub en el dock (abriéndolo si hace falta).",
  "shortcuts.dockBrowser": "Navegador",
  "shortcuts.dockBrowserDesc": "Muestra el navegador en el dock (abriéndolo si hace falta).",
  ...
  "agentEditor.workersUnattended": "Modo automático al lanzarlo un agente",
  "agentEditor.workersUnattendedReviewed": "Los workers que arranca un coordinador corren en el modo automático revisado de este CLI; tus propios lanzamientos no cambian.",
  "agentEditor.workersUnattendedEditsOnly": "A los workers que arranca un coordinador este CLI les aprueba las ediciones de archivos; los comandos de shell y las herramientas MCP siguen preguntando. Tus propios lanzamientos no cambian.",
  "agentEditor.workersUnattendedNone": "Este CLI no tiene un modo automático revisado; los workers se lanzan tal como están configurados.",
  ...
  "orchestration.drivenBy": "Dirigida por {agent}",
  "orchestration.drivenByShell": "Dirigida desde una shell",
  "orchestration.drivenCoordinatorGone": "La terminal del coordinador está cerrada",
  "orchestration.revealCoordinator": "Mostrar la terminal del coordinador",
  "orchestration.outcomeSuccess": "Con éxito",
  "orchestration.outcomeFailure": "Fallida",
  "orchestration.outcomeBlocked": "Bloqueada",
  "orchestration.runsSteps": "Pasos",
  "orchestration.inbox": "Bandeja",
  "orchestration.inboxWaiting": "{count} en espera",
  "orchestration.inboxEmpty": "Nada en espera: el coordinador ya leyó todo.",
  "orchestration.inboxWorkerDone": "Worker terminado",
  "orchestration.inboxWorkerFailed": "Worker fallido",
  "orchestration.inboxQuestion": "Pregunta",
  "orchestration.inboxStatus": "Estado",
  "orchestration.drivenChip": "dirigida",
  "orchestration.inboxCount": "{count} en la bandeja",
  ...
  "browser.searchEngine": "Motor de búsqueda",
  "browser.searchEngineDesc": "A dónde manda la barra de direcciones todo lo que no es una dirección.",
  "browser.searchCustom": "Personalizado",
  "browser.searchUrl": "URL de búsqueda",
  "browser.searchUrlDesc": "Una dirección http(s) con %s donde va la búsqueda.",
  "browser.searchUrlInvalid": "Necesita una dirección http(s) que contenga %s; mientras tanto, las búsquedas van a Google.",
  "browser.back": "Atrás",
  "browser.forward": "Adelante",
  "browser.reload": "Recargar",
  "browser.agentExternalSites": "Permitir a los agentes otros sitios",
  "browser.agentExternalSitesDesc": "Los agentes siempre pueden leer y usar páginas de esta máquina (sus servidores de desarrollo). Actívalo para que también lean y actúen en otros sitios: cada sitio sigue necesitando tu aprobación una vez, y todo lo que envíe, borre, pague o inicie sesión pregunta cada vez.",
  "browser.approvalTitle": "Un agente necesita tu aprobación",
  "browser.approvalRead": "{agent} quiere leer esta página",
  "browser.approvalScreenshot": "{agent} quiere hacer una captura de esta página",
  "browser.approvalConsole": "{agent} quiere leer la consola de esta página",
  "browser.approvalClick": "{agent} quiere hacer clic en {target}",
  "browser.approvalType": "{agent} quiere escribir en {target}",
  "browser.approvalPress": "{agent} quiere pulsar una tecla en {target}",
  "browser.approvalScroll": "{agent} quiere desplazar esta página",
  "browser.approvalHigh": "Puede enviar, borrar, pagar o iniciar sesión",
  "browser.approvalDeny": "Denegar",
  "browser.approvalOnce": "Permitir",
  "browser.approvalSite": "Permitir en {host}",
  "browser.approvalPending": "Un agente espera tu aprobación en el navegador",
  "browser.stop": "Detener carga",
  "browser.address": "Dirección",
  "browser.zoomReset": "Restablecer zoom",
  "browser.downloaded": "Descargado en {path}",
  "browser.downloadFailed": "La descarga falló.",
  "browser.openExternal": "Abrir en el navegador del sistema",
  "browser.devtools": "Herramientas de desarrollo",
  "browser.closePage": "Cerrar página",
  "browser.closeBrowser": "Cerrar el navegador",
  "browser.goHome": "Volver a la página de inicio",
  "browser.closeAction": "Botón de cerrar",
  "browser.closeActionDesc": "Lo que hace la ✕ de la barra del navegador.",
  "browser.closeActionNoHome": "No hay página de inicio, así que la ✕ vacía la página; configura una arriba.",
  "browser.closeAction.blank": "Vaciar la página",
  "browser.closeAction.home": "Volver a la página de inicio",
  "browser.closeAction.dock": "Cerrar el navegador y el panel",
  "browser.empty": "Escribe una dirección arriba, o abre un enlace desde una terminal o un agente.",
  "dock.toggle": "Mostrar u ocultar el dock derecho",
  "dock.choose": "Elige qué mostrar",
  "dock.chooserTitle": "¿Qué quieres abrir?",
  "dock.chooserSubtitle": "Elige qué muestra el dock de este workspace. Lo recordará, y puedes cambiarlo desde el selector de arriba.",
  "dock.filesDesc": "Explora y edita los archivos de este workspace.",
  "dock.gitDesc": "Prepara, confirma y revisa cambios, y consulta el historial.",
  "dock.githubDesc": "El pull request de esta rama, sus checks y las issues del repositorio.",
  "dock.browserDesc": "Previsualiza tu servidor de desarrollo o cualquier sitio; los agentes también pueden probarlo.",
  "dock.checksSuccess": "checks en verde",
  "dock.checksFailure": "checks fallando",
  "dock.checksPending": "checks en curso",
  "dock.waitingApproval": "un agente espera",
  "dock.files": "Archivos",
  "dock.git": "Git",
  "dock.github": "GitHub",
  "dock.browser": "Navegador",
  "dock.reviewChanges": "clic para revisarlos",
  ...
  "automations.proposedTitle": "Este borrador llegó por la API de control",
  "automations.proposedLeaveTitle": "¿Salir sin guardar este borrador?",
  "automations.proposedLeaveDesc": "Aquí no se ha creado nada: el borrador y los cambios que le hayas hecho se descartan, y no hay forma de recuperarlos. Guardarlo lo deja en tu lista, en pausa.",
  "automations.proposedLeaveDiscard": "Descartar y salir",
  "automations.proposedBy": "{agent} redactó esta automatización",
  "automations.proposedDesc": "No se ha creado ni programado nada. Léela, cambia lo que quieras y pulsa Guardar: se guarda en pausa, así que solo empieza a ejecutarse cuando la actives en la lista.",
  "automations.proposedDiscard": "Descartar",
  ...
  "hosts.noGit": "Sin git en esta maquina — los cambios, el historial y la busqueda lo necesitan alli.",
  ...
  "settings.bridge": "Bridge y móvil",
  "settings.bridgeDesc": "El bridge de Uxnan conduce las conversaciones de las pestañas de chat — las mismas que muestra Uxnan Mobile, así que cualquiera de los dos puede continuarlas.",
  "bridge.mode": "Conexión",
  "bridge.modeLabel.off": "Apagada",
  "bridge.modeLabel.attach": "Usar un bridge en marcha",
  "bridge.modeLabel.managed": "Como servicio",
  "bridge.modeDesc.off": "Uxnan no se conecta al bridge: ni socket, ni proceso, ni coste. Las pestañas de chat no están disponibles.",
  "bridge.modeDesc.attach": "Conectarse a un bridge que ya ejecutas (como servicio, o con `uxnan-bridge start` en una terminal).",
  "bridge.modeDesc.managed": "Uxnan instala el bridge como servicio de tu usuario y lo mantiene en marcha, así tu teléfono sigue funcionando con Uxnan cerrado.",
  "bridge.status": "Estado",
  "bridge.statusOff": "Apagada",
  "bridge.statusConnecting": "Conectando con el bridge…",
  "bridge.statusConnected": "Conectado — bridge {version}",
  "bridge.statusConnectedManaged": "Conectado — bridge {version}, mantenido por Uxnan",
  "bridge.unavailable.notRunning": "No hay ningún bridge en marcha en esta máquina.",
  "bridge.unavailable.notInstalled": "El bridge no está instalado (uxnan-bridge no está en el PATH).",
  "bridge.unavailable.serviceFailed": "No se pudo instalar o iniciar el servicio del bridge.",
  "bridge.unavailable.rejected": "El bridge en marcha rechazó esta app.",
  "bridge.unavailable.failed": "No se pudo conectar con el bridge.",
  "bridge.unavailable.outdated": "El bridge en ejecución es demasiado antiguo para Uxnan Desktop: actualízalo.",
  "bridge.unavailable.channelOff": "Hay un bridge en ejecución sin el canal del escritorio: reinícialo para usar la versión instalada.",
  "bridge.restartAction": "Reiniciar el bridge",
  "bridge.restarting": "Reiniciando…",
  "bridge.restartOk": "El bridge se reinició",
  "bridge.checkAgain": "Comprobar de nuevo",
  "bridge.orRunIt": "O ejecútalo tú mismo en una terminal:",
  "bridge.version": "Bridge",
  "bridge.checking": "Comprobando qué está instalado…",
  "bridge.notInstalledDesc": "Aún no está instalado. Uxnan puede instalarlo por ti con npm.",
  "bridge.needsNode": "No está instalado y npm no está disponible: instala antes Node.js 18 o superior (nodejs.org).",
  "bridge.versionInstalled": "Instalado: {version}",
  "bridge.versionUnknown": "Instalado (no informa su versión: es anterior al comando de versión)",
  "bridge.updateAvailable": "{version} está disponible",
  "bridge.updatingTo": "actualizando a {version}…",
  "bridge.olderThanApp": "más antiguo que esta app — actualízalo",
  "bridge.updateFailed": "El bridge no pudo actualizarse solo. Abajo dice por qué.",
  "bridge.updatedOk": "El bridge ya es la versión {version}",
  "bridge.updateFailedToast": "El bridge no pudo actualizarse a {version}",
  "sidebar.bridgeUpdate": "Actualizar el bridge a {version}",
  "sidebar.bridgeUpdateOlder": "Actualizar el bridge",
  "sidebar.bridgeUpdating": "Actualizando el bridge…",
  "sidebar.bridgeUpdateHint": "Instala el bridge publicado y lo reinicia — nunca con un turno en curso",
  "bridge.installAction": "Instalar",
  "bridge.updateAction": "Actualizar",
  "bridge.installing": "Instalando…",
  "bridge.updating": "Actualizando…",
  "bridge.installOk": "El bridge de Uxnan {version} está instalado",
  "bridge.installFailed": "npm no pudo instalarlo. La salida de abajo dice por qué; también puedes copiar el comando y ejecutarlo en una terminal.",
  "bridge.permissionDenied": "npm no tiene permiso para escribir su carpeta global. Copia el comando y ejecútalo en una terminal (o configura un prefijo de npm de usuario).",
  "bridge.showOutput": "Salida de npm",
  "bridge.autoUpdate": "Actualizar automáticamente",
  "bridge.autoUpdateDesc": "Cuando se publique un bridge más nuevo, actualizar el que ejecuta Uxnan en un momento en que ninguna conversación esté trabajando (en ningún dispositivo).",
  "chat.gateInstallTitle": "Instala el bridge de Uxnan para chatear",
  "chat.gateInstallDesc": "Los chats corren en el bridge, que te deja continuarlos desde Uxnan Mobile. Uxnan puede instalarlo ahora con npm, o puedes copiar el comando.",
  "bridge.retry": "Reintentar",
  "bridge.phones": "Teléfonos",
  "bridge.phonesDesc": "Todos los teléfonos emparejados con esta computadora, con el mismo nombre en todos lados. Renómbralo aquí o en el teléfono: gana el nombre más reciente.",
  "bridge.pairAction": "Emparejar un teléfono",
  ...
  "bridge.pairDoneDesc": "Ve los mismos proyectos y conversaciones que Uxnan. Renómbralo cuando quieras en Ajustes → Bridge y móvil.",
  "bridge.pairDoneTitle": "Teléfono conectado",
  "bridge.pairWaiting": "Esperando a tu teléfono · {seconds} s",
  "bridge.pairStarting": "Encendiendo el bridge…",
  "bridge.pairTurnOnHint": "Corre como servicio de tu usuario, así el teléfono funciona aunque Uxnan esté cerrado.",
  "bridge.pairTurnOn": "Encender el bridge",
  "bridge.pairOffDesc": "Tu teléfono habla con esta computadora a través del bridge, que no está corriendo.",
  "bridge.home": "Carpeta de inicio",
  "bridge.homeDesc": "Donde empieza la búsqueda de un proyecto nuevo, aquí y en el teléfono.",
  "bridge.homeChange": "Cambiar…",
  "bridge.homeChanged": "Carpeta de inicio cambiada",
  "bridge.noPhones": "Todavía no hay teléfonos emparejados.",
  "bridge.pcNameChanged": "Nombre de la computadora cambiado",
  "bridge.pcNameDesc": "Cómo llaman tus teléfonos y Uxnan a esta computadora. Vacío usa su nombre del sistema.",
  "bridge.pcName": "Nombre de la computadora",
  "bridge.sharedDesc": "Ajustes que usan todos tus teléfonos y esta app para esta computadora.",
  "bridge.shared": "Compartido con tus teléfonos",
  "bridge.phoneRemoved": "{name} desemparejado",
  "bridge.phoneRemoveDesc": "Ya no podrá conectarse a esta computadora hasta que lo vuelvas a emparejar. Sus conversaciones se conservan.",
  "bridge.phoneRemoveTitle": "¿Desemparejar {name}?",
  "bridge.phoneRemove": "Desemparejar",
  "bridge.phoneRename": "Renombrar",
  "bridge.phoneAway": "Sin conexión",
  "bridge.phoneConnected": "Conectado",
  "chat.newChat": "Nuevo chat",
  "chat.gateTitle": "Los chats corren en el bridge de Uxnan",
  "chat.gateOff": "Conéctate al bridge para iniciar conversaciones que también puedes continuar desde Uxnan Mobile.",
  "chat.gateConnect": "Conectar",
  "chat.gateSettings": "Ajustes del bridge",
  "chat.startTitle": "¿Qué construimos en {folder}?",
  "chat.startHint": "La conversación corre en el bridge de Uxnan, así que también aparece en tu teléfono y cualquiera de los dos puede continuarla.",
  "chat.chooseAgent": "Agente",
  "chat.agentsLoading": "Cargando agentes…",
  "chat.notInstalled": "No instalado",
  "chat.agentFixedHint": "El agente queda fijo en la conversación; el modelo se puede cambiar en cualquier momento.",
  "chat.continue": "Continuar una conversación",
  "chat.showAll": "Ver las {n}",
  "chat.showFewer": "Ver menos",
  "chat.startPlaceholder": "Mensaje para iniciar el chat…",
  "chat.composerPlaceholder": "Escribe al agente…",
  "chat.composerLabel": "Mensaje",
  "chat.send": "Enviar",
  "chat.queue": "Encolar",
  "chat.stop": "Detener",
  "chat.queueHint": "El agente está trabajando: este mensaje espera su turno (o entra en el que está en curso, en agentes que aceptan entrada a mitad de turno).",
  ...
  "chat.commandGroup.builtin": "Integrados",
  "chat.exitCode": "salida {code}",
  "chat.failed": "falló",
  "chat.riskHigh": "Riesgo alto",
  "chat.approve": "Permitir",
  "chat.approveSession": "Siempre en esta sesión",
  "chat.reject": "Denegar",
  "chat.approvalDecision.approve": "Permitido",
  "chat.approvalDecision.approveSession": "Permitido en esta sesión",
  "chat.approvalDecision.reject": "Denegado",
  "chat.approvalTimedOut": "Sin respuesta a tiempo — denegado",
  "chat.skip": "Omitir",
  "chat.submit": "Responder",
  "chat.questionSkipped": "Omitida",
  "chat.questionTimedOut": "Sin respuesta a tiempo.",
  "chat.plan": "Plan",
  "chat.subagent": "Subagente",
  "chat.compacted": "Contexto compactado",
  "chat.thinking": "Razonamiento",
  "chat.working": "Trabajando…",
  "chat.stopped": "Detenido",
  "chat.cancelled": "Cancelado antes de ejecutarse",
  "chat.syncedHint": "Sincronizado con Uxnan Mobile a través del bridge",
  "chat.accessLabel": "Modo de acceso",
  "chat.access.requestApproval": "Preguntar antes",
  "chat.access.approveForMe": "Aprobar ediciones",
  "chat.access.fullAccess": "Acceso total",
  "chat.accessDesc.requestApproval": "El agente pregunta antes de cada acción arriesgada.",
  "chat.accessDesc.approveForMe": "Las ediciones rutinarias pasan; las acciones arriesgadas siguen preguntando.",
  "chat.accessDesc.fullAccess": "El agente actúa sin preguntar.",
  "chat.more": "Más",
  "chat.action.open": "Abrir",
  "chat.action.rename": "Renombrar…",
  "chat.action.archive": "Archivar",
  "chat.action.unarchive": "Restaurar",
  "chat.action.delete": "Eliminar…",
  "chat.deleteTitle": "¿Eliminar este chat?",
  "chat.deleteDesc": "“{title}” y su historial se eliminan del bridge para todos los dispositivos — este equipo y tu teléfono. No se puede deshacer.",
  "chat.deleteConfirm": "Eliminar",
  "chat.archivedSection": "Archivados",
  "chat.archivedHint": "Fuera de todas las listas, en todos los dispositivos. Restaura uno para continuarlo.",
  "chat.archivedBanner": "Este chat está archivado, en todos los dispositivos. Restáuralo para continuar.",
  ...
  "chat.verbRan": "Ejecutó",
  "chat.verbRunning": "Ejecutando",
  "chat.verbEdited": "Editó",
  "chat.verbTool": "Herramienta",
  "chat.verbRead": "Leyó",
  "chat.verbSearched": "Buscó",
  "chat.verbListed": "Listó",
  "chat.verbFetched": "Abrió",
  "chat.verbSearchedWeb": "Buscó en la web",
  "chat.workCommandsOne": "Ejecutó {n} comando",
  "chat.workCommands": "Ejecutó {n} comandos",
  "chat.workEditsOne": "{n} edición",
  "chat.workEdits": "{n} ediciones",
  "chat.workToolsOne": "{n} llamada a herramienta",
  "chat.workTools": "{n} llamadas a herramientas",
  "chat.workAgentsOne": "{n} subagente",
  "chat.workAgents": "{n} subagentes",
  "chat.workFailedOne": "{n} falló",
  "chat.workFailed": "{n} fallaron",
  "chat.workingFor": "Trabajando desde hace {time}",
  "chat.workedFor": "Trabajó {time}",
  "chat.stoppedAfter": "Detenido tras {time}",
  "chat.failedAfter": "Falló tras {time}",
  "chat.showWork": "Ver el trabajo",
  "chat.filesChangedOne": "{n} archivo cambiado",
  "chat.filesChanged": "{n} archivos cambiados",
  "chat.queuedCountOne": "{n} mensaje en cola",
