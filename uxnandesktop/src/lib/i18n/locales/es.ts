...
export const es: Record<MessageKey, string> = {
  ...
  "github.settings.aiDesc": "Redacta opcionalmente el cuerpo del PR y resúmenes de review a partir del diff, con un agente CLI instalado.",
  "github.settings.aiAgent": "Agente",
  "github.settings.aiModel": "Modelo",
  "github.settings.aiNone": "Desactivado",
