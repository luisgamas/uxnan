...
export const es: Record<MessageKey, string> = {
  ...
  "bridge.phonesDesc": "Teléfonos conectados a este bridge ahora mismo. Ven los mismos proyectos y conversaciones que Uxnan.",
  ...
  "bridge.projects": "Proyectos",
  "bridge.projectsDesc": "Tus proyectos aquí y en el teléfono son una sola lista: agregar o quitar uno en cualquiera se ve en ambos. Quitar un proyecto nunca borra sus conversaciones.",
  ...
  "bridge.phoneSince": "Conectado desde {time}",
  "bridge.noPhones": "No hay ningún teléfono conectado ahora mismo.",
