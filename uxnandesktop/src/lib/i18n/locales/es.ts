...
export const es: Record<MessageKey, string> = {
  ...
  "bridge.pairTitle": "Emparejar un teléfono",
  "bridge.pairDesc": "En Uxnan Mobile, agrega una computadora y escanea este código. El teléfono sigue funcionando con esta computadora aunque Uxnan esté cerrado.",
  "bridge.pairQrLabel": "Código QR de emparejamiento",
  "bridge.pairExpires": "Válido por {seconds} s",
