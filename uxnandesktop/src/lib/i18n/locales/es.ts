...
export const es: Record<MessageKey, string> = {
  ...
  "bridge.install": "Obtener el bridge",
  "bridge.installDesc": "Instálalo una vez; Uxnan lo encuentra en el PATH como cualquier CLI de agente.",
  "bridge.startDesc": "Inícialo en una terminal, o cambia la conexión a «Iniciar el bridge cuando haga falta».",
  ...
  "chat.modelDefault": "Modelo por defecto",
  "chat.modelResolved": "Ejecutando como {model}",
  "chat.modelsLoading": "Cargando modelos…",
