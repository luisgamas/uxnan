...
export const en = {
  ...
  "bridge.modeLabel.managed": "Start the bridge when needed",
  ...
  "bridge.modeDesc.managed": "Connect to a running bridge, or start `uxnan-bridge` if none is running and stop it when Uxnan closes.",
  "bridge.status": "Status",
  "bridge.statusOff": "Off",
  "bridge.statusConnecting": "Connecting to the bridge…",
  "bridge.statusConnected": "Connected — bridge {version}",
  "bridge.statusConnectedManaged": "Connected — bridge {version}, started by Uxnan",
  ...
  "bridge.phonesDesc": "Phones connected to this bridge right now. Pair a new one with `uxnan-bridge qr` in a terminal.",
