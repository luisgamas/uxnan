...
export const en = {
  ...
  "toast.projectRemovedElsewhere": "Project removed on another device",
  ...
  "sidebar.connectPhone": "Connect a phone",
  "sidebar.connectPhoneHint": "Pair Uxnan Mobile with this computer: scan a QR code and you're in.",
  "sidebar.phoneAndOthers": "{name} +{n}",
  "sidebar.phoneOnline": "{name} is connected",
  "sidebar.phoneOffline": "{name} is not connected right now",
  ...
  "welcome.eyebrow": "Welcome to Uxnan",
  "welcome.welcome.title": "Every coding agent, in one place.",
  "welcome.welcome.body": "Run Claude Code, Codex, OpenCode, pi and the rest side by side — each in its own terminal or chat, on its own worktree — and see what every one of them is doing at a glance.",
  "welcome.modes.title": "Terminal or chat — your call.",
  "welcome.modes.body": "Open an agent in a terminal for its full interface, or in a chat tab for a calm conversation: approvals and questions above the composer, / for its commands and skills, @ for files, and images.",
  "welcome.modes.terminal": "Terminal",
  "welcome.modes.chat": "Chat",
  "welcome.modes.approval": "Edit 2 files",
  "welcome.modes.approve": "Approve",
  "welcome.phone.title": "Your phone, in the same conversation.",
  "welcome.phone.body": "Pair Uxnan Mobile once. Your projects and chats are the same on both, the phone keeps working while Uxnan is closed, and whatever you do on one shows up on the other — even what you did offline.",
  "welcome.phone.connect": "Connect a phone",
  "welcome.phone.linked": "Linked with Uxnan Desktop",
  "welcome.phone.message": "Message Claude Code…",
  "welcome.team.title": "Agents that work together.",
  "welcome.team.body": "Inside Uxnan, agents get its tools: create a worktree, hand a task to another agent, open the browser, read a terminal. From outside, uxnan-cli and the control API do the same, and automations run them on a schedule.",
  "welcome.agents.title": "Your agents.",
  "welcome.agents.body": "These are the coding agents found on this computer. Add others any time in Settings → Agents; Uxnan picks up a newly installed one on its own.",
  "welcome.ready.title": "You're ready.",
  "welcome.ready.body": "A few keys worth knowing — every one can be changed in Settings → Shortcuts.",
  "welcome.ready.search": "Find a project or worktree",
  "welcome.ready.addProject": "Add a project",
  "welcome.ready.newTerminal": "New terminal",
  "welcome.ready.settings": "Settings",
  "welcome.ready.addFirstProject": "Add your first project",
  "welcome.skip": "Skip",
  "welcome.back": "Back",
  "welcome.next": "Next",
  "welcome.done": "Start",
  "welcome.progress": "Tour steps",
  "sidebarProfile.welcome": "Welcome tour",
  ...
  "editor.search.options": "Search options",
  ...
  "shortcuts.toggleRightSidebar": "Toggle right dock",
  "shortcuts.toggleRightSidebarDesc": "Show or hide the right dock (Files · Git · GitHub · Browser) of this workspace.",
  "shortcuts.dockFiles": "Files",
  "shortcuts.dockFilesDesc": "Show Files in the dock (opening it if needed).",
  "shortcuts.dockGit": "Git",
  "shortcuts.dockGitDesc": "Show Git — changes and history — in the dock (opening it if needed).",
  "shortcuts.dockGithub": "GitHub",
  "shortcuts.dockGithubDesc": "Show GitHub in the dock (opening it if needed).",
  "shortcuts.dockBrowser": "Browser",
  "shortcuts.dockBrowserDesc": "Show the browser in the dock (opening it if needed).",
  ...
  "agentEditor.workersUnattended": "Automatic mode when launched by an agent",
  "agentEditor.workersUnattendedReviewed": "Workers a coordinator starts run in this CLI's reviewed automatic mode; your own launches are not affected.",
  "agentEditor.workersUnattendedEditsOnly": "Workers a coordinator starts have this CLI approve their file edits; shell commands and MCP tools still prompt. Your own launches are not affected.",
  "agentEditor.workersUnattendedNone": "This CLI has no reviewed automatic mode; workers launch as configured.",
  ...
  "orchestration.drivenBy": "Driven by {agent}",
  "orchestration.drivenByShell": "Driven from a shell",
  "orchestration.drivenCoordinatorGone": "The coordinator's terminal is closed",
  "orchestration.revealCoordinator": "Show the coordinator's terminal",
  "orchestration.outcomeSuccess": "Succeeded",
  "orchestration.outcomeFailure": "Failed",
  "orchestration.outcomeBlocked": "Blocked",
  "orchestration.runsSteps": "Steps",
  "orchestration.inbox": "Inbox",
  "orchestration.inboxWaiting": "{count} waiting",
  "orchestration.inboxEmpty": "Nothing waiting — the coordinator has read everything.",
  "orchestration.inboxWorkerDone": "Worker done",
  "orchestration.inboxWorkerFailed": "Worker failed",
  "orchestration.inboxQuestion": "Question",
  "orchestration.inboxStatus": "Status",
  "orchestration.drivenChip": "driven",
  "orchestration.inboxCount": "{count} in inbox",
  ...
  "browser.searchEngineDesc": "Where the address bar sends anything that is not an address.",
  "browser.searchCustom": "Custom",
  "browser.searchUrl": "Search URL",
  "browser.searchUrlDesc": "An http(s) address with %s where the search goes.",
  "browser.searchUrlInvalid": "Needs an http(s) address containing %s — until then, searches go to Google.",
  "browser.back": "Back",
  "browser.forward": "Forward",
  "browser.reload": "Reload",
  "browser.agentExternalSites": "Let agents use other sites",
  "browser.agentExternalSitesDesc": "Agents can always read and use pages on this machine (their dev servers). Turn on to let them read and act on other sites too — each site still needs your approval once, and anything that submits, deletes, pays or signs in asks every time.",
  "browser.approvalTitle": "An agent needs your approval",
  "browser.approvalRead": "{agent} wants to read this page",
  "browser.approvalScreenshot": "{agent} wants to take a screenshot of this page",
  "browser.approvalConsole": "{agent} wants to read this page's console",
  "browser.approvalClick": "{agent} wants to click {target}",
  "browser.approvalType": "{agent} wants to type into {target}",
  "browser.approvalPress": "{agent} wants to press a key on {target}",
  "browser.approvalScroll": "{agent} wants to scroll this page",
  "browser.approvalHigh": "May submit, delete, pay or sign in",
  "browser.approvalDeny": "Deny",
  "browser.approvalOnce": "Allow",
  "browser.approvalSite": "Allow on {host}",
  "browser.approvalPending": "An agent is waiting for your approval in the browser",
  "browser.stop": "Stop loading",
  "browser.address": "Address",
  "browser.zoomReset": "Reset zoom",
  "browser.downloaded": "Downloaded to {path}",
  "browser.downloadFailed": "The download failed.",
  "browser.openExternal": "Open in system browser",
  "browser.devtools": "Developer tools",
  "browser.closePage": "Close page",
  "browser.closeBrowser": "Close the browser",
  "browser.goHome": "Back to the home page",
  "browser.closeAction": "Close button",
  "browser.closeActionDesc": "What the ✕ in the browser's toolbar does.",
  "browser.closeActionNoHome": "No home page is set, so the ✕ clears the page — set one above.",
  "browser.closeAction.blank": "Clear the page",
  "browser.closeAction.home": "Go back to the home page",
  "browser.closeAction.dock": "Close the browser and the panel",
  "browser.empty": "Type an address above, or open a link from a terminal or an agent.",
  "dock.toggle": "Show or hide the right dock",
  "dock.choose": "Choose what to show",
  "dock.chooserTitle": "What do you want to open?",
  "dock.chooserSubtitle": "Pick what this workspace's dock shows. It will remember it, and you can switch from the selector above.",
  "dock.filesDesc": "Browse and edit this workspace's files.",
  "dock.gitDesc": "Stage, commit and review changes, and see the history.",
  "dock.githubDesc": "This branch's pull request, its checks and the repository's issues.",
  "dock.browserDesc": "Preview your dev server or any site; agents can test it too.",
  "dock.checksSuccess": "checks passing",
  "dock.checksFailure": "checks failing",
  "dock.checksPending": "checks running",
  "dock.waitingApproval": "an agent is waiting",
  "dock.files": "Files",
  "dock.git": "Git",
  "dock.github": "GitHub",
  "dock.browser": "Browser",
  "dock.reviewChanges": "click to review them",
  ...
  "automations.proposedTitle": "This draft came from the control API",
  "automations.proposedLeaveTitle": "Leave without saving this draft?",
  "automations.proposedLeaveDesc": "Nothing here has been created: the draft and any change you made to it are thrown away, and there is no way back to them. Saving keeps it in your list, paused.",
  "automations.proposedLeaveDiscard": "Discard and leave",
  "automations.proposedBy": "{agent} drafted this automation",
  "automations.proposedDesc": "Nothing has been created or scheduled. Read it, change what you want and press Save — it is saved paused, so it only starts running once you turn it on in the list.",
  "automations.proposedDiscard": "Discard",
  ...
  "settings.bridge": "Bridge & mobile",
  "settings.bridgeDesc": "The Uxnan bridge drives the conversations of chat tabs — the same ones Uxnan Mobile shows, so either can continue them.",
  "bridge.mode": "Connection",
  "bridge.modeLabel.off": "Off",
  "bridge.modeLabel.attach": "Use a running bridge",
  "bridge.modeLabel.managed": "Run it as a service",
  "bridge.modeDesc.off": "Uxnan does not connect to the bridge: no socket, no process, no cost. Chat tabs stay unavailable.",
  "bridge.modeDesc.attach": "Connect to a bridge you already run (as a service, or `uxnan-bridge start` in a terminal).",
  "bridge.modeDesc.managed": "Uxnan installs the bridge as your user's service and keeps it running, so your phone keeps working while Uxnan is closed.",
  "bridge.status": "Status",
  "bridge.statusOff": "Off",
  "bridge.statusConnecting": "Connecting to the bridge…",
  "bridge.statusConnected": "Connected — bridge {version}",
  "bridge.statusConnectedManaged": "Connected — bridge {version}, kept running by Uxnan",
  "bridge.unavailable.notRunning": "No bridge is running on this machine.",
  "bridge.unavailable.notInstalled": "The bridge is not installed (uxnan-bridge is not on PATH).",
  "bridge.unavailable.serviceFailed": "Could not install or start the bridge's service.",
  "bridge.unavailable.rejected": "The running bridge refused this app.",
  "bridge.unavailable.failed": "Could not connect to the bridge.",
  "bridge.unavailable.outdated": "The running bridge is too old to talk to Uxnan Desktop: update it.",
  "bridge.unavailable.channelOff": "A bridge is running without the desktop channel: restart it to run the version installed now.",
  "bridge.restartAction": "Restart the bridge",
  "bridge.restarting": "Restarting…",
  "bridge.restartOk": "The bridge restarted",
  "bridge.checkAgain": "Check again",
  "bridge.orRunIt": "Or run it yourself in a terminal:",
  "bridge.version": "Bridge",
  "bridge.checking": "Checking what is installed…",
  "bridge.notInstalledDesc": "Not installed yet. Uxnan can install it for you with npm.",
  "bridge.needsNode": "Not installed, and npm is not available: install Node.js 18 or newer first (nodejs.org).",
  "bridge.versionInstalled": "Installed: {version}",
  "bridge.versionUnknown": "Installed (version not reported — it predates the version command)",
  "bridge.updateAvailable": "{version} is available",
  "bridge.updatingTo": "updating to {version}…",
  "bridge.olderThanApp": "older than this app — update it",
  "bridge.updateFailed": "The bridge could not update itself. It says why below.",
  "bridge.updatedOk": "The bridge is now {version}",
  "bridge.updateFailedToast": "The bridge could not update to {version}",
  "sidebar.bridgeUpdate": "Update the bridge to {version}",
  "sidebar.bridgeUpdateOlder": "Update the bridge",
  "sidebar.bridgeUpdating": "Updating the bridge…",
  "sidebar.bridgeUpdateHint": "Installs the published bridge and restarts it — never under a running turn",
  "bridge.installAction": "Install",
  "bridge.updateAction": "Update",
  "bridge.installing": "Installing…",
  "bridge.updating": "Updating…",
  "bridge.installOk": "Uxnan bridge {version} is installed",
  "bridge.installFailed": "npm could not install it. The output below says why; you can also copy the command and run it in a terminal.",
  "bridge.permissionDenied": "npm has no permission to write its global folder. Copy the command and run it in a terminal (or set a user-level npm prefix).",
  "bridge.showOutput": "npm output",
  "bridge.autoUpdate": "Update automatically",
  "bridge.autoUpdateDesc": "When a newer bridge is published, update the one Uxnan runs, at a moment no conversation is working (on any device).",
  "chat.gateInstallTitle": "Install the Uxnan bridge to chat",
  "chat.gateInstallDesc": "Chats run on the bridge, which lets you continue them from Uxnan Mobile. Uxnan can install it now with npm, or you can copy the command.",
  "bridge.retry": "Retry",
  "bridge.phones": "Phones",
  "bridge.phonesDesc": "Every phone paired to this computer, named the same everywhere. Rename one here or on the phone — the latest name wins.",
  "bridge.pairAction": "Pair a phone",
  ...
  "bridge.pairDoneDesc": "It sees the same projects and conversations as Uxnan. Rename it any time in Settings → Bridge & mobile.",
  "bridge.pairDoneTitle": "Phone connected",
  "bridge.pairWaiting": "Waiting for your phone · {seconds} s",
  "bridge.pairStarting": "Starting the bridge…",
  "bridge.pairTurnOnHint": "It runs as your user's service, so the phone still works with Uxnan closed.",
  "bridge.pairTurnOn": "Turn on the bridge",
  "bridge.pairOffDesc": "Your phone talks to this computer through the bridge, which isn't running.",
  "bridge.home": "Start folder",
  "bridge.homeDesc": "Where looking for a new project begins, here and on the phone.",
  "bridge.homeChange": "Change…",
  "bridge.homeChanged": "Start folder changed",
  "bridge.noPhones": "No phone is paired yet.",
  "bridge.pcNameChanged": "Computer name changed",
  "bridge.pcNameDesc": "What your phones and Uxnan call this computer. Empty uses its system name.",
  "bridge.pcName": "Computer name",
  "bridge.sharedDesc": "Settings every phone and this app use for this computer.",
  "bridge.shared": "Shared with your phones",
  "bridge.phoneRemoved": "{name} unpaired",
  "bridge.phoneRemoveDesc": "It can no longer connect to this computer until you pair it again. Its conversations stay.",
  "bridge.phoneRemoveTitle": "Unpair {name}?",
  "bridge.phoneRemove": "Unpair",
  "bridge.phoneRename": "Rename",
  "bridge.phoneAway": "Not connected",
  "bridge.phoneConnected": "Connected",
  "chat.newChat": "New chat",
  "chat.gateTitle": "Chats run on the Uxnan bridge",
  "chat.gateOff": "Connect to the bridge to start conversations you can also continue from Uxnan Mobile.",
  "chat.gateConnect": "Connect",
  "chat.gateSettings": "Bridge settings",
  "chat.startTitle": "What should we build in {folder}?",
  "chat.startHint": "The conversation runs on the Uxnan bridge, so it shows up on your phone too and either can continue it.",
  "chat.chooseAgent": "Agent",
  "chat.agentsLoading": "Loading agents…",
  "chat.notInstalled": "Not installed",
  "chat.agentFixedHint": "The agent stays with the conversation; the model can change at any time.",
  "chat.continue": "Continue a conversation",
  "chat.showAll": "Show all {n}",
  "chat.showFewer": "Show fewer",
  "chat.startPlaceholder": "Message to start the chat…",
  "chat.composerPlaceholder": "Message the agent…",
  "chat.composerLabel": "Message",
  "chat.send": "Send",
  "chat.queue": "Queue",
  "chat.stop": "Stop",
  "chat.queueHint": "The agent is working: this message waits for its turn (or joins the running one, on agents that take input mid-turn).",
  ...
  "chat.commandGroup.builtin": "Built-in",
  "chat.exitCode": "exit {code}",
  "chat.failed": "failed",
  "chat.riskHigh": "High risk",
  "chat.approve": "Allow",
  "chat.approveSession": "Always this session",
  "chat.reject": "Deny",
  "chat.approvalDecision.approve": "Allowed",
  "chat.approvalDecision.approveSession": "Allowed for this session",
  "chat.approvalDecision.reject": "Denied",
  "chat.approvalTimedOut": "No answer in time — denied",
  "chat.skip": "Skip",
  "chat.submit": "Answer",
  "chat.questionSkipped": "Skipped",
  "chat.questionTimedOut": "No answer in time.",
  "chat.plan": "Plan",
  ...
  "chat.cancelled": "Cancelled before it ran",
  "chat.syncedHint": "Synced with Uxnan Mobile through the bridge",
  "chat.accessLabel": "Access mode",
  "chat.access.requestApproval": "Ask first",
  "chat.access.approveForMe": "Auto-approve edits",
  "chat.access.fullAccess": "Full access",
  "chat.accessDesc.requestApproval": "The agent asks before each risky action.",
  "chat.accessDesc.approveForMe": "Routine edits go through; risky actions still ask.",
  "chat.accessDesc.fullAccess": "The agent acts without asking.",
  "chat.more": "More",
  "chat.action.open": "Open",
  "chat.action.rename": "Rename…",
  "chat.action.archive": "Archive",
  "chat.action.unarchive": "Restore",
  "chat.action.delete": "Delete…",
  "chat.deleteTitle": "Delete this chat?",
  "chat.deleteDesc": "“{title}” and its history are deleted from the bridge for every device — this computer and your phone. This can't be undone.",
  "chat.deleteConfirm": "Delete",
  "chat.archivedSection": "Archived",
  "chat.archivedHint": "Out of every list, on every device. Restore one to continue it.",
  "chat.archivedBanner": "This chat is archived — on every device. Restore it to continue.",
  ...
  "chat.verbRan": "Ran",
  "chat.verbRunning": "Running",
  "chat.verbEdited": "Edited",
  "chat.verbTool": "Tool",
  "chat.verbRead": "Read",
  "chat.verbSearched": "Searched",
  "chat.verbListed": "Listed",
  "chat.verbFetched": "Fetched",
  "chat.verbSearchedWeb": "Searched the web",
  "chat.workCommandsOne": "Ran {n} command",
  "chat.workCommands": "Ran {n} commands",
  "chat.workEditsOne": "{n} edit",
  "chat.workEdits": "{n} edits",
  "chat.workToolsOne": "{n} tool call",
  "chat.workTools": "{n} tool calls",
  "chat.workAgentsOne": "{n} subagent",
  "chat.workAgents": "{n} subagents",
  "chat.workFailedOne": "{n} failed",
  "chat.workFailed": "{n} failed",
  "chat.workingFor": "Working for {time}",
  "chat.workedFor": "Worked for {time}",
  "chat.stoppedAfter": "Stopped after {time}",
  "chat.failedAfter": "Failed after {time}",
  "chat.showWork": "Show the work",
  "chat.filesChangedOne": "{n} file changed",
  "chat.filesChanged": "{n} files changed",
  "chat.queuedCountOne": "{n} message queued",
