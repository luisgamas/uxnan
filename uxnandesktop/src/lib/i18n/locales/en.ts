...
export const en = {
  ...
  "bridge.retry": "Retry",
  "bridge.install": "Get the bridge",
  "bridge.installDesc": "Install it once; Uxnan finds it on PATH like any agent CLI.",
  "bridge.startDesc": "Start it in a terminal, or switch the connection to “Start the bridge when needed”.",
  ...
  "chat.modelResolved": "Running as {model}",
