...
export const en = {
  ...
  "bridge.phonesDesc": "Phones connected to this bridge right now. They see the same projects and conversations as Uxnan.",
  ...
  "bridge.projectsDesc": "Your projects here and on the phone are one list: adding or removing one on either shows on both. Removing a project never deletes its conversations.",
  ...
  "bridge.phoneSince": "Connected since {time}",
  "bridge.noPhones": "No phone is connected right now.",
