...
export const en = {
  ...
  "bridge.pairTitle": "Pair a phone",
  "bridge.pairDesc": "In Uxnan Mobile, add a computer and scan this code. The phone keeps working with this computer while Uxnan is closed.",
  "bridge.pairQrLabel": "Pairing QR code",
  "bridge.pairExpires": "Valid for {seconds} s",
