...
# developer browser, honoring the user's link policy — in the browser of the
# workspace this terminal belongs to (named by UXNAN_AGENT_ID, the terminal's
# id). Best-effort and silent: if
