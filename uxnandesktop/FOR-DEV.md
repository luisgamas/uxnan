...
with" external editors/IDEs**). 256 Rust backend tests + 212 frontend Vitest unit tests (pure logic); **no Svelte component or E2E tests yet**. macOS is **unvalidated**
...
- ✅ **Verify** — `.github/workflows/ci-desktop.yml` runs svelte-check + `npm test`
  ...
  deferred with Apple). 256 Rust + 212 Vitest tests.
