...
GitHub tests, 1 real-scheduler probe) + 1,251 passing frontend Vitest tests across two
...
- ✅ **Verify** — `.github/workflows/ci-desktop.yml` runs svelte-check + `npm test`
  ...
  keeps the default `{ubuntu, windows}`. 809 Rust + 1,251 passing Vitest tests (both
