...
**in-app auto-updater**, **browser-control MCP for agents**). 159 Rust backend tests + 121 frontend Vitest unit tests (pure logic); **no Svelte component or E2E tests yet**. macOS is **unvalidated**
...
- ✅ **Verify** — `.github/workflows/ci-desktop.yml` runs svelte-check + `npm test`
  ...
  deferred with Apple). 159 Rust + 121 Vitest tests.
