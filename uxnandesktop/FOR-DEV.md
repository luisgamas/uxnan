...
engine**, **user quick commands**, **GitHub integration (`gh`-backed)**). 229 Rust backend tests + 192 frontend Vitest unit tests (pure logic); **no Svelte component or E2E tests yet**. macOS is **unvalidated**
