...
engine**, **user quick commands**, **GitHub integration (`gh`-backed)**). 238 Rust backend tests + 192 frontend Vitest unit tests (pure logic); **no Svelte component or E2E tests yet**. macOS is **unvalidated**
...
- ✅ **Verify** — `.github/workflows/ci-desktop.yml` runs svelte-check + `npm test`
  ...
  deferred with Apple). 238 Rust + 192 Vitest tests.
