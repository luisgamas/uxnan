...
GitHub tests, 1 real-scheduler probe) + 1,358 passing frontend Vitest tests across two
...
- ✅ **Verify** — `.github/workflows/ci-desktop.yml` runs svelte-check + `npm test`
  ...
  keeps the default `{ubuntu, windows}`. 953 Rust + 1,358 passing Vitest tests (both
