...
with" external editors/IDEs**, **pets**). 353 Rust backend tests + 285 frontend Vitest unit tests (pure logic); **no Svelte component or E2E tests yet**. macOS now ships an
