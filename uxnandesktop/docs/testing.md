...
The 730 passing unit tests (772 with the ignored probes) cover the Serde model shape, persistence round-trip / atomicity /
...
ships in every build and is never shown). **1,251 passing tests** across both
