...
[`github-sandbox-runbook.md`](github-sandbox-runbook.md)). **590 backend tests**
in total (plus the 7 ignored live tests and the ignored real-scheduler probe).

The 561 passing unit tests cover the Serde model shape, persistence round-trip / atomicity /
