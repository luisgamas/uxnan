...
[`github-sandbox-runbook.md`](github-sandbox-runbook.md)). **540 backend tests**
in total (plus the 7 ignored live tests and the ignored real-scheduler probe).

The 511 passing unit tests cover the Serde model shape, persistence round-trip / atomicity /
...
[`platform-support.md`](platform-support.md)). **1,017 passing tests** across both projects,
