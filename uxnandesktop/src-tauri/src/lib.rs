...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_grok_hooks_status,
            commands::install_grok_hooks,
            commands::uninstall_grok_hooks,
            commands::get_antigravity_hooks_status,
            commands::install_antigravity_hooks,
            commands::uninstall_antigravity_hooks,
