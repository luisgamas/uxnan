...
| Conversación — **UI** (`ConversationScreen` con M3 + Neural Expressive, renderers, composer anclado abajo) cableada a datos reales | ✅ Hecho | Auto-follow cede al scroll manual; proceso secundario en disclosures tonales contraídos; prompts largos expandibles; modelo/agente del thread, git por `cwd` real |
