...
| **Indicador "Responding…" por thread** | ✅ Hecho | `ThreadActivity` + `threadActivityProvider`; indicador por thread en la lista y estado discreto junto al composer en la conversación |
